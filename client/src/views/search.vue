!<template>
  <div class="searchVideoContainer">
    ...
    <div class="centreBody">
        ...
        <div class="videoContent">
            ...
            <h3 v-if="result">{{collectionList.length}} result has found</h3>
            
             <h3 v-if="!result">No result has found</h3>
            <ul v-if="result">
  ...
  export default {
   ...
   async created(){
       ...
       this.allVideo = videoResult.data
        ...
        const searchVideo = await VideoService.videoBySearch(text)
         
         if(searchVideo.data==""){
           this.result =false;
         }else{
            this.collectionList = searchVideo.data
         }
   },
