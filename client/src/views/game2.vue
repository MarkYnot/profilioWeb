    ...
    <div class="centreBody">
          ...
          <div class="videoContent">
                <section class="videoPlayer">
                     <iframe ref="iframe" width="100%" height="100%" scrolling="no" border="no" src="/5620game2/index.html" frameborder="0" marginheight="0" marginwidth="0" autoplay:0/>
                </section>
             ...
             <div class="videoIntro">
                  <span class="introTitle">The Ball Set</span><br/><br/><br/><br/>

                  <span class="gameDescription">A ball intereaction game</span>
